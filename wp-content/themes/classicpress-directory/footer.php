	...
	<footer id="colophon">
		<div class="classic">
			<div class="footerleft">
				...
				<div class="registration"><p><?php _e('The ClassicPress project is under the direction of The ClassicPress Initiative, a nonprofit organization registered under section 501(c)(3) of the United States IRS code.', 'classicpress'); ?></p>
	...
	<footer id="legal">
		<div class="cplegal">
			<div class="cpcopyright">
				<p><?php printf(__('© 2018-%s ClassicPress Initiative. All Rights Reserved.', 'classicpress'), date( 'Y' )); ?></p>
			</div>
			<div class="cppolicy">
