...
use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\Doctrine\Common\Cache\CacheProvider;
...
class DoctrineProvider extends CacheProvider implements PruneableInterface, ResettableInterface
{
    ...
    {
        trigger_deprecation('symfony/cache', '5.4', '"%s" is deprecated, use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\"Doctrine\Common\Cache\Psr6\DoctrineProvider" instead.', __CLASS__);
