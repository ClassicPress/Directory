...
use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\Doctrine\DBAL\Connection;
use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\Doctrine\DBAL\DriverManager;
use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\Doctrine\DBAL\Exception as DBALException;
use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\Doctrine\DBAL\Exception\TableNotFoundException;
use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\Doctrine\DBAL\ParameterType;
use WildWolf\WordPress\TwoFactorWebAuthn\Vendor\Doctrine\DBAL\Schema\Schema;
...
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
     ...
     *
     * @throws InvalidArgumentException When namespace WildWolf\WordPress\TwoFactorWebAuthn\Vendor\contains invalid characters
     */
